...
return [
    ...
    */
    ...
    'dimensions' => ':attribute Ölçüleri Geçersiz!',
    ...
    'integer' => ':attribute alanı sayı olarak girilmelidir.',
    ...
    //'required_if' => ':attribute alanı, :other değeri mevcut olduğunda zorunludur.',
    ...
    */
    ...
    'attributes' => [
        ...
        'body' => 'İçerik',
        'ogdescription' => 'Facebook Açıklama',
        'meta_desc' => 'Kısa Açıklama',
        'twimage' => 'Twitter Görseli',
        ...
        'custom_url' => 'Özel URL',
        'image' => 'Resim',
        'cover_image' => 'Haber Görseli',
        'cover_image_title' => 'Haber Resim Açıklama',
        'cover_slider_image' => 'Manşet Görseli',
        'slider_image' => 'Üst Manşet Görseli',
        'vertical_image' => 'Dikey Haber Görseli',
        'ogimage' => 'Facebook Görseli',
        'display_name' => 'Ad Soyad',
        'code' => 'Kod',
        'area' => 'Reklam Konumu',
        'width' => 'Genişlik',
        'height' => 'Yükseklik',
        'special' => 'Gösterim Sayfaları',
        'url' => 'URL Adresi',
        'tag' => 'Etiket',
        'slug' => 'Slug',
        'tag_slug' => 'Slug',
        'tag_related_info' => 'İlişkili İçerik ID',
        'topic' => 'Konu',
        'ogtitle' => 'Facebook Sayfa Başlığı',
        'role_name' => 'Yetki Rol Adı',
        'options' => 'Seçenekler',
        'gender' => 'Cinsiyet',
        'birthday' => 'Doğum Günü',
        'phone' => 'Telefon', 
        ...
        'desc_tr' => 'İngilizce Başlık',
        'title_en' => 'Türkçe Metin',
        'desc_en' => 'İngilizce Metin',
        'text1_tr' => 'Birinci Türkçe Metin',
        'text1_en' => 'İkinci İngilizce Metin',
        'text2_tr' => 'Birinci Türkçe Metin',
        'text2_en' => 'İkinci İngilizce Metin',
        'selected_icon' => 'İkon',
        'lit_desc_tr' => 'Türkçe Kısa Açıklama',
        'lit_desc_en' => 'İngilizce Kısa Açıklama',
        'title' => 'Başlık',
        'education' => 'Öğrenim derecesi',
        'graduate' => 'Mezuniyet yılı',
    ...
    'errors' => [
        'login' => 'Kullanıcı adı veya Şifre geçersiz',
    ],
